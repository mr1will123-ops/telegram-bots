...
# ВСЕ ТОКЕНЫ ИЗ ПЕРЕМЕННЫХ ОКРУЖЕНИЯ
BOT1_TOKEN = os.getenv("BOT1_TOKEN")  # Переходник
BOT2_TOKEN = os.getenv("BOT2_TOKEN")  # Выбор ника
BOT3_TOKEN = os.getenv("BOT3_TOKEN")  # Админ-бот в канале
